 ...
 * @author Наташа
 */
public class GraphViz_1 {

    private static final Logger log = Logger.getLogger(GraphViz_1.class.getName());
    /**
    ...
    public static File writeDotGraphToFile(String location, String name, String type, String graph) {
        log.info("GraphViz_1: file_name = " + name);

        File file = new File(location + "\\" + name.replaceAll("<|>", " ") + "." + type);
